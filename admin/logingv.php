...
if(isset($_POST['gv'])){
	...
	if($ugv && $pgv){
		$query="select * from giangvien where Magv='$ugv' and passwordgv='$pgv'";
...
<div style="margin-top:20px;text-align: center;font-weight: bold;font-size: 25px;font-family: Tahoma ">TRANG GIẢNG VIÊN</div>
