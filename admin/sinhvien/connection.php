...
if (!$conn){
$conn = mysqli_connect('localhost', 'root', '', 'quanlydiemsv') or die ('Can\'t not connect to database');
...
// Câu truy vấn lấy tất cả sinh viên
$sql = "select * from sinhvien where Masv = {$student_id}";
...
// Câu truy vấn thêm
$sql = "
INSERT INTO sinhvien(Masv,MaLopHoc,Tensv,GioiTinh,NgaySinh,noisinh,dantoc,hotencha,hotenme) VALUES
